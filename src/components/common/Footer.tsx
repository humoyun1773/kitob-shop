...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-slate-100/90 dark:bg-[#0F172A] text-slate-600 dark:text-slate-300 pt-16 pb-28 lg:pb-12 border-t border-slate-200 dark:border-slate-800/80 transition-colors duration-200 overflow-hidden">
